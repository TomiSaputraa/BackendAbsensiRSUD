/*
  ...
  - The `tanggal_input_izin` column on the `izin` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
ALTER TABLE `izin` MODIFY `tanggal_mulai_izin` DATETIME NOT NULL,
    ...
    DROP COLUMN `tanggal_input_izin`,
    ADD COLUMN `tanggal_input_izin` INTEGER NULL;
