...
-- AlterTable
ALTER TABLE `user` ADD COLUMN `ruangan` VARCHAR(20) NULL,
    MODIFY `jenis_kelamin` ENUM('Pria', 'Wanita') NULL DEFAULT 'Pria',
    MODIFY `bergabung_sejak` DATETIME NULL DEFAULT CURRENT_TIMESTAMP(3),
    MODIFY `grup` ENUM('Group_1', 'Group_2', 'Juru_Masak_1', 'Juru_Masak_', 'Pj_Lauk_Hewani', 'None') NULL DEFAULT 'None',
    MODIFY `jabatan` ENUM('Kepala_Instalasi', 'Nutrisionis', 'Logistik', 'Administrasi', 'None') NULL DEFAULT 'None';
