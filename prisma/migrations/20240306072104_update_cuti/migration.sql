...
-- AlterTable
ALTER TABLE `sakit` MODIFY `tanggal_mulai_sakit` VARCHAR(20) NOT NULL,
    MODIFY `tanggal_selesai_sakit` VARCHAR(20) NOT NULL,
    MODIFY `tanggal_input_sakit` DATETIME NULL DEFAULT CURRENT_TIMESTAMP(3);
