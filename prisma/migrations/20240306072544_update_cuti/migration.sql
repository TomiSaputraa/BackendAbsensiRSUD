...
-- AlterTable
ALTER TABLE `cuti` MODIFY `tanggal_mulai_cuti` VARCHAR(20) NOT NULL,
    MODIFY `tanggal_selesai_cuti` VARCHAR(20) NOT NULL,
    MODIFY `tanggal_input_cuti` DATETIME NULL DEFAULT CURRENT_TIMESTAMP(3);

-- AlterTable
ALTER TABLE `izin` MODIFY `tanggal_input_izin` DATETIME NULL DEFAULT CURRENT_TIMESTAMP(3);
